                            ...
                            <li class="list-group-item border-0 p-4 mb-3 bg-gradient-light border-radius-lg">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4 col-lg-3 d-flex d-md-block">
                                        <a class="btn btn-primary flex-fill m-2 d-block" href="{{ route('admin.quiz.question.destroy', [$quiz->id, $question->id]) }}"><i
                                                class="material-icons text-sm me-2">delete</i>Delete</a>
                                        <a class="btn btn-info flex-fill m-2 d-block" href="{{ route('admin.quiz.question.edit', [$quiz->id, $question->id]) }}"><i
